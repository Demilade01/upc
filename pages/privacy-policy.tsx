  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Privacy Policy for Upcoming Wipes - Your Rust server finder" />
      </Head>
      <div className="min-h-screen bg-black-800 flex flex-col">
        <main className="flex-grow container mx-auto px-4 py-12">
          ...
          <div className="space-y-6 text-white">
            ...
            <p>Welcome to Upcoming Wipes ("we", "our", or "us"). We respect your privacy and are committed to protecting your personal data.</p>
            ...
            <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">4. Your Rights</h2>
            <p>You have the right to access, correct, or delete your personal data.</p>

            <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">5. Changes to This Policy</h2>
            <p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>

            <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">6. Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us at: upcomingwipes@gmail.com</p>
          </div>
        </main>
