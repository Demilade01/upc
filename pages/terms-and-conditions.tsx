  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Terms and Conditions for Upcoming Wipes - Your Rust server finder" />
      </Head>
      <div className="min-h-screen bg-black-800 flex flex-col">
        <main className="flex-grow container mx-auto px-4 py-12">
          <Link href="/" className="inline-block mb-8 text-primary hover:text-white transition duration-300">
            &larr; Back to Home
          </Link>
          ...
          <div className="space-y-6 text-white">
            ...
            <p>The service and its original content, features, and functionality are and will remain the exclusive property of Upcoming Wipes.</p>

            <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">4. Termination</h2>
            ...
            <p>In no event shall Upcoming Wipes be liable for any indirect, incidental, special, consequential or punitive damages.</p>
            ...
            <p>If you have any questions about these Terms, please contact us at: upcomingwipes@gmail.com</p>
          </div>
        </main>
